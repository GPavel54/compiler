...
CodeGen.o: src/CodeGen.cpp
	g++ -Wall --std=c++11 -c -o build/CodeGen.o src/CodeGen.cpp -g
functions.o: src/functions.cpp
	g++ -Wall --std=c++11 -c -o build/functions.o src/functions.cpp -g
compiler:
	g++ -Wall --std=c++11 -o bin/compiler build/compiler.o build/Lexer.o build/Parser.o build/CodeGen.o build/functions.o -g
clean:
	rm build/*.o
	rm bin/compiler
